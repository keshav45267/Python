...
# print the list of sorted tuples 
print(t_list)

# create dictionary fron the sorted tuples as value:key
tup_dict = dict(t_list)
print(tup_dict)

# create new  dictionary from the sorted tuple list as key value pair 
ndict={}
for k,v in t_list:
    ndict[v]=k
